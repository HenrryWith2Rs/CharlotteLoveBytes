...
const GuestTable = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (params) => (
        <div>
          <Button onClick={() => handleRead(params.row.id)} sx={{ color: 'white', minWidth: '40px' }}>
            <VisibilityIcon />
          </Button>
          <Button onClick={() => handleUpdate(params.row.id)} sx={{ color: 'white', minWidth: '40px' }}>
            <EditIcon />
          </Button>
          <Button onClick={() => handleDelete(params.row.id)} sx={{ color: 'white', minWidth: '40px' }}>
            <DeleteIcon />
          </Button>
        </div>
      ),
